 ...
 */
object W3L1_MOTIF_ENUMERATION extends App {
  val dnaSequence = "GTGCGATCTGTATCCCTTCATAGCC\nCTTCGCGGATGTCCCATAATACCCA\nCTTTCAAAGAGCTAGGGTGTGTTTG\nCTATATATAGCTTTTACCCGACGCC\nTCGAAGTTAGCTTATCCGGGTAGTT\nACGACTCCGTCTTACGGGACCACCT"
  val results = DNAProfiler.motifEnumeration(dnaSequence.split("\n").toList,5,2)

  val res = results.sorted.mkString(" ")
